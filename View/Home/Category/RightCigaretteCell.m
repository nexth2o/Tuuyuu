...
@implementation RightCigaretteCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        //标题
        _rightTitle = [[UILabel alloc] initWithFrame:CGRectMake(8*SCALE, 8*SCALE, SCREEN_WIDTH-100*SCALE, 15*SCALE)];
        _rightTitle.textColor = [UIColor darkGrayColor];
        _rightTitle.font = [UIFont systemFontOfSize:13*SCALE];
        [self addSubview:_rightTitle];
        
        //副标题
        _rightSubTitle = [[UILabel alloc] initWithFrame:CGRectMake(8*SCALE, CGRectGetMaxY(_rightTitle.frame)+5*SCALE, SCREEN_WIDTH-100*SCALE, 12*SCALE)];
        ...
        //标签
        _label1 = [[UIImageView alloc] initWithFrame:CGRectMake(8*SCALE, CGRectGetMaxY(_rightSubTitle.frame)+7*SCALE, 20.87*SCALE, 11*SCALE)];
        ...
        //价格
        _price = [[UILabel alloc] initWithFrame:CGRectMake(10*SCALE, CGRectGetMaxY(_label1.frame)+8*SCALE, 70*SCALE, 12*SCALE)];
        _price.textColor = [[UIColor redColor] colorWithAlphaComponent:0.8];
        _price.font = [UIFont boldSystemFontOfSize:12*SCALE];
        [self addSubview:_price];
        
        _soldOut = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_price.frame)+0*SCALE, CGRectGetMaxY(_label1.frame)+2*SCALE, 46*SCALE, 20*SCALE)];
        [_soldOut setImage:[UIImage imageNamed:@"sold_out"]];
        [_soldOut setHidden:YES];
        [self addSubview:_soldOut];
