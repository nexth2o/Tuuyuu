...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        //标题
        _rightTitle = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_rightImageView.frame)+8*SCALE, 8*SCALE, SCREEN_WIDTH-100*SCALE-CGRectGetMaxX(_rightImageView.frame), 15*SCALE)];
        _rightTitle.textColor = [UIColor darkGrayColor];
        _rightTitle.font = [UIFont systemFontOfSize:13*SCALE];
        [self addSubview:_rightTitle];
        
        //副标题
        _rightSubTitle = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_rightImageView.frame)+8*SCALE, CGRectGetMaxY(_rightTitle.frame)+5*SCALE, SCREEN_WIDTH-100*SCALE-CGRectGetMaxX(_rightImageView.frame), 12*SCALE)];
        ...
        //标签
        _label1 = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_rightImageView.frame)+8*SCALE, CGRectGetMaxY(_rightSubTitle.frame)+7*SCALE, 20.87*SCALE, 11*SCALE)];
        [self addSubview:_label1];
        
        _label2 = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_label1.frame)+5*SCALE, CGRectGetMaxY(_rightSubTitle.frame)+7*SCALE, 20.87*SCALE, 11*SCALE)];
        [self addSubview:_label2];
        
        _label3 = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_label2.frame)+5*SCALE, CGRectGetMaxY(_rightSubTitle.frame)+7*SCALE, 20.87*SCALE, 11*SCALE)];
        [self addSubview:_label3];
        
        _label4 = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_label3.frame)+5*SCALE, CGRectGetMaxY(_rightSubTitle.frame)+7*SCALE, 20.87*SCALE, 11*SCALE)];
        [self addSubview:_label4];
        
        _label5 = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_label4.frame)+5*SCALE, CGRectGetMaxY(_rightSubTitle.frame)+7*SCALE, 20.87*SCALE, 11*SCALE)];
        [self addSubview:_label5];
        
        _label6 = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_label5.frame)+5*SCALE, CGRectGetMaxY(_rightSubTitle.frame)+7*SCALE, 20.87*SCALE, 11*SCALE)];
        [self addSubview:_label6];
        
        //价格
        _price = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_rightImageView.frame)+8*SCALE, CGRectGetMaxY(_label1.frame)+5*SCALE, 80*SCALE, 12*SCALE)];
        _price.textColor = [[UIColor redColor] colorWithAlphaComponent:0.8];
        _price.font = [UIFont boldSystemFontOfSize:12*SCALE];
        [self addSubview:_price];
        
        _oldPriceLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_price.frame)+0*SCALE, CGRectGetMaxY(_label1.frame)+5*SCALE, 70*SCALE, 10*SCALE)];
        [self addSubview:_oldPriceLabel];
        
        //成箱
        _packageBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_packageBtn setFrame:CGRectMake(SCREEN_WIDTH - 55*SCALE-90*SCALE, CGRectGetMaxY(_rightTitle.frame)+3*SCALE, 55*SCALE, 25*SCALE)];
        ...
        lineView = [[UIView alloc] initWithFrame:CGRectMake(0, 80*SCALE, SCREEN_WIDTH, 2*SCALE)];
...
- (void)layoutSubviews {
    ...
    [selectedBackView setFrame:CGRectMake(0, 0, SCREEN_WIDTH, 80*SCALE)];
