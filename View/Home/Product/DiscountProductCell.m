...
@implementation DiscountProductCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _giftLabel = [[UILabel alloc] initWithFrame:CGRectMake((110-50)*SCALE, CGRectGetMaxY(_rightImageView.frame)+5*SCALE, 50*SCALE, 15*SCALE)];
        ...
        [_plus2 setFrame:CGRectMake(SCREEN_WIDTH -44*SCALE, _giftSubTitle.frame.origin.y+0*SCALE, 44*SCALE, 44*SCALE)];
        ...
        [_minus2 setFrame:CGRectMake(SCREEN_WIDTH -50*SCALE- 44*SCALE, _giftSubTitle.frame.origin.y+0*SCALE, 44*SCALE, 44*SCALE)];
        ...
        //数量
        _orderCount2 = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH -12*SCALE- 44*SCALE, _giftSubTitle.frame.origin.y+12*SCALE, 20*SCALE, 20*SCALE)];
        ...
        [_packageBtn setFrame:CGRectMake(SCREEN_WIDTH - 55*SCALE-90*SCALE, CGRectGetMaxY(_rightTitle.frame)+18*SCALE, 55*SCALE, 25*SCALE)];
